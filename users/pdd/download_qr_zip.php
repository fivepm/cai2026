...
// Ambil semua peserta
$result = $conn->query("SELECT nama, kelompok, barcode FROM peserta ORDER BY kelompok, nama ASC");
...
$tmp_zip = tempnam(sys_get_temp_dir(), 'qr_zip_');
$zip = new ZipArchive();
...
// Kirim ke browser
$zip_filename = 'QRCode_Peserta_CAI2025_' . date('Ymd_His') . '.zip';
