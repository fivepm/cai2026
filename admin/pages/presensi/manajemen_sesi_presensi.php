<?php
// (File: admin/pages/presensi/manajemen_sesi_presensi.php)
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action'])) {
    ...
    header("Location: admin?page=presensi/manajemen_sesi_presensi");
    exit();
}
...
<div x-data="manajemenSesi()">
    ...
    <div class="flex justify-between items-center">
        ...
        <button @click="openTambahModal()"
                class="px-5 py-2.5 font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 active:bg-blue-800 flex items-center gap-2 shadow-md transition-all">
    ...
    <div class="mt-5 bg-white shadow-md rounded-xl overflow-hidden">
        ...
        <div class="block md:hidden border-t border-gray-100 divide-y divide-gray-100">
            ...
            <div class="p-4 bg-white hover:bg-gray-50 transition-colors">
                <h3 class="font-bold text-gray-800 text-base mb-1"><?php echo htmlspecialchars($item['nama_sesi']); ?></h3>
                <p class="text-sm text-gray-600 mb-0.5"><i class="fas fa-calendar-days mr-1.5 text-blue-400"></i><?php echo date('d M Y', strtotime($item['tanggal_sesi'])); ?></p>
    ...
    <div x-show="isDeleteModalOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50" x-cloak x-transition>
        <div @click.away="isDeleteModalOpen = false" class="bg-white rounded-2xl shadow-2xl w-full max-w-sm mx-4 overflow-hidden">
            <div class="bg-gradient-to-r from-red-500 to-red-600 px-6 py-4 flex items-center gap-3">
                <div class="bg-white bg-opacity-20 rounded-lg p-2"><i class="fas fa-triangle-exclamation text-white"></i></div>
